...
/*
        ...
        */
        ...
        const config={
          ...
          const data=await axios.get("https://api.unsplash.com/search/photos?page=1&query=office",config);
          return data;
  ...
  export const fetchImages = createAsyncThunk(
    ...
    async () => {
       ...
       const config={
        ...
        const data=await axios.get("https://www.googleapis.com/books/v1/volumes?q=premchand",config);
        return data;
